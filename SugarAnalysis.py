...
countries = ['FRANCE', 'SOUTH AFRICA', 'UNITED KINGDOM', 'UNITED STATES', 'SPAIN', 'NETHERLANDS', 'AUSTRALIA', 'CANADA', 'GERMANY']
...
plt.title('Average total sugar content per 100g is depicted below :')
plt.xticks(y_pos, countries)
plt.ylabel('Sugar content/100g')
